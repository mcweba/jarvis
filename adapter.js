...
app.post('/button2/single', (request, response) => {
        requestAPI.post(
            {url: urlPrefix + 'MyStrom_Button2_Single',
            headers: {'Content-Type': 'text/plain'}
            },
            function (error, resp, body) {
                if (!error && resp.statusCode == 200) {
...
app.post('/button2/double', (request, response) => {
        requestAPI.post(
            {url: urlPrefix + 'MyStrom_Button2_Double',
            headers: {'Content-Type': 'text/plain'}
            },
            function (error, resp, body) {
                if (!error && resp.statusCode == 200) {
...
app.post('/button2/long', (request, response) => {
        requestAPI.post(
            {url: urlPrefix + 'MyStrom_Button2_Long',
            headers: {'Content-Type': 'text/plain'}
            },
            function (error, resp, body) {
                if (!error && resp.statusCode == 200) {
